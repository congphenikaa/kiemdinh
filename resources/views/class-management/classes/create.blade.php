    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-1">
                ...
                <p class="form-hint">Nhập số sinh viên tối đa cho lớp</p>
            </div>
            <div class="md:col-span-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-1">
                ...
                <p class="form-hint">Có thể để trống nếu chưa có</p>
            </div>
            <div class="md:col-span-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-1">
                ...
                <p class="form-hint">Ví dụ: Sáng, Chiều, Tối</p>
            </div>
            <div class="md:col-span-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-1">
                ...
                <p class="form-hint">Chọn trạng thái lớp học</p>
            </div>
            <div class="md:col-span-2">
