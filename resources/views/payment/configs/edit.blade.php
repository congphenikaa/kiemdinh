    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-1">
                ...
                <p class="form-hint">Chọn năm học áp dụng cấu hình</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-1">
                <label for="base_salary_per_session" class="form-label">
                    Lương cơ bản/buổi <span class="text-red-500">*</span>
                </label>
                <p class="form-hint">Lương cơ bản cho mỗi buổi dạy (VNĐ)</p>
            </div>
            <div class="md:col-span-2">
