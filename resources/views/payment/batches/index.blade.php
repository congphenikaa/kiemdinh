                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right space-x-1">
                                ...
                                @endif
                                <a href="{{ route('payment-batches.export', $batch->id) }}" 
                                   class="inline-flex items-center p-1 bg-green-100 text-green-800 rounded hover:bg-green-200 transition-colors" title="Xuất Excel">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
